...
set CLASSPATH=%APP_HOME%\lib\OpcuaIndustrial-all.jar

@rem Execute OpcuaIndustrial
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %OPCUA_INDUSTRIAL_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%OPCUA_INDUSTRIAL_EXIT_CONSOLE%" exit 1
exit /b 1
