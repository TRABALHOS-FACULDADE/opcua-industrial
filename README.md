...
plc {
  ...
  port = 4840
  nodePattern = "ns=2;s=led{id}"
  nodeAddresses = "ns=2;s=Device.led1,ns=2;s=Device.led2"
...
| `PLC_NODE_PATTERN` | `plc.nodePattern` |
| `PLC_NODE_ADDRESSES` | `plc.nodeAddresses` |
...
```bash
cd /mnt/c/Users/reisb/Downloads/redes2/salve
export PLC_NODE_ADDRESSES='ns=2;s=YOUR_REAL_LED1_NODE_ID'
./gradlew run
```
...
5. Set `PLC_NODE_PATTERN` for sequential addresses, or
   `PLC_NODE_ADDRESSES` with a comma-separated list of exact NodeIds
